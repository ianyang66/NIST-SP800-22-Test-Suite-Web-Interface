...
@WebServlet("/sp80022m-std.do")

public class sp80022m_std extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		if (checkLock){
			...
			switch(isAscii){
			case "ascii":
				sysCmd = new String[]{home_directory + "sts", "-s", "-S", bitCounts, "-i", iterations, "-t", "0", "-w", work_directory + rndFileName, "-F", "a", upload_directory + rndFileName};
				break;
			case "binary":
				sysCmd = new String[]{home_directory + "sts", "-s", "-S", bitCounts, "-i", iterations, "-t", "0", "-w", work_directory + rndFileName, "-F", "r", upload_directory + rndFileName};
				break;
			}
			/*
