...
<center>
	...
	<h3><a href = "http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-22r1a.pdf" target="_blank">A Statistical Test Suite for Random and Pseudorandom Number Generators for Cryptographic Applications - Advance mode</a></h3>
	<form action = "sp80022m-adv.do" method="post" enctype="multipart/form-data">
		<table border = "2">
			<tr>
				<td>
				...
				<td>
					<table border ="2">
						<tr>
							...
							<td>
								<input type = "text" name="bitCounts" value="1048576">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name="iterations" value = "1">
							</td>
						</tr>
					</table>
				</td>
				...
				<td>
					<table border=2>
						...
						<tr>
							...
							<td>
								<input type = "text" name = "blockFreq" value="16384">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name = "novLapping" value = "9">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name = "ovLapping" value = "9">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name = "approxEnt" value = "10">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name = "srTest" value = "16">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name = "linComplex" value = "500">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<fieldset id = "uniBins">
									<input type = "radio" value = "sqrt" name = "uniBins" checked = "checked"> sqrt(iterations) <br>
									<input type = "radio" value = "10" name = "uniBins"> 10 <br>
								</fieldset>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type = "text" name = "uniCut" value = "0.0001">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "text" name = "alphaConf" value = "0.01">;
							</td>
						</tr>
					</table>
				</td>
